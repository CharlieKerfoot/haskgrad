...
/* package haskgrad-0.1.0.0 */
#ifndef VERSION_haskgrad
#define VERSION_haskgrad "0.1.0.0"
#endif /* VERSION_haskgrad */
#ifndef MIN_VERSION_haskgrad
#define MIN_VERSION_haskgrad(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_haskgrad */
...
#define CURRENT_COMPONENT_ID "haskgrad-0.1.0.0-inplace-haskgrad"
